...
This project was completed as part of the **Large Language Model and It's applications** module (3 ECTS credits) at the **ZHAW Center for Artificial Intelligence**.
